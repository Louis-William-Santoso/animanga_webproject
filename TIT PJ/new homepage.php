<!DOCTYPE html>
  ...
  <div class="mySlides">
    ...
    <div class="mySlides">
    <img src="images/miku_banner.jpg" style="width:100%">
    <h2></h2>  
    </div>
   ...
   <h1>Our Product</h1>
    ...
    <table>
	<tr>
    <td width="49%" height="442" align="center"><a href="voca.php"><img src="images/sddefault.jpg" alt="" width="448" height="355" /></a>
     <h3> Vocaloid </h3>
